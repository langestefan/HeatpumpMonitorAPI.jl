...
const SPEC_SRC = joinpath(pkgdir(HeatpumpMonitorAPI), "spec", "openapi.json")
...
makedocs(;
    modules = [HeatpumpMonitorAPI],
    sitename = "HeatpumpMonitorAPI.jl",
    authors = "langestefan",
    format = MarkdownVitepress(;
        repo = "github.com/langestefan/HeatpumpMonitorAPI.jl",
        devbranch = "main",
        devurl = "dev",
